# experiments/08_pseudobulk_mse.py
"""
Train on the training split of VCC.

Assume no change in predictions.

Uses pseudobulk MSE for training. Not as good as MDD^2 but it's better than cell-line MSE. However, we do not overfit on a single batch.
"""
